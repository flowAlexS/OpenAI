...
import { callPublicApiLLMNotificationTubRendered, myCustomPanelRendered, myCustomSidebarBoxRendered, myCustomTabRendered } from "./handlers/panelsHandlers"
...
const elements: ExtensionElement[] = [
    ...
    {
        elementId: "llmRepoTab",
        text: "LLM History Hub",
        location: "projects-list-tabpanel",
        type: "tab",
        actions: [
            {
                eventType: "onrender",
                eventHandler: callPublicApiLLMNotificationTubRendered,
                payload: []
            }
        ]
    },
