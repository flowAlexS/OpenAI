...
using Trados.GenAI.Addon.LMStudio.Infrastructure;
...
namespace Trados.GenAI.Addon.LMStudio.Controllers
{
    [Route("v1")]
    [ApiController]
    public class TranslationController : ControllerBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        /// [FromBody] BCMModelRequest request
        [Authorize]
        [HttpPost("translate")]
        public async Task<IActionResult> Translate()
        {
            ...
            var lMStudioModel = await _settingsService.GetSettings(tenantId);

            var translationCoordinator =
                TranslationCoordinatorFactory.BuildCoordinator(
                    new AIModelBuilder(lMStudioModel),
                    TranslationStorageFactory.CreateTranslationStorageService(
                        "LM Studio Provider", tenantId),
            ...
            var translationRequest = new TranslationRequest()
            {
                ...
                IncludeTags = lMStudioModel.IncludeTags,
                UseCache = lMStudioModel.UseCached
            };
        ...
        ///!IMPORTANT
        ///This Method is not fully done
        ///Minimum was done
        ///Review it as you grow this app...
        /// <summary>
