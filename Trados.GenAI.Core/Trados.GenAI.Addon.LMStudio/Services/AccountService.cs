...
using Trados.GenAI.Addon.LMStudio.DAL.Entities.Extensions;
...
using Trados.GenAI.Addon.LMStudio.Models.Extensions;
...
namespace Trados.GenAI.Addon.LMStudio.Services
{
    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task<ConfigurationSettingsResult> GetConfigurationSettings(string tenantId, CancellationToken cancellationToken)
        {
            ...
            return new ConfigurationSettingsResult(accountInfo.ConfigurationValues.ToModel());
        }
